...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mevis_exp_path",
        type=str,
        default="/data1/pengrui/CodeSpace/Sa2VA/data/Sa2VA-Training/video_datas/davis17/meta_expressions/valid/meta_expressions.json",
    )
    parser.add_argument(
        "--mevis_mask_path",
        type=str,
        default="/data1/pengrui/CodeSpace/Sa2VA/data/Sa2VA-Training/video_datas/davis17/valid/mask_dict.pkl",
    )
