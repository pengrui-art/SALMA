...
# Ensure project root is on sys.path when running as `python tools/eval/eval_mevis.py ...`
import sys
...
# Correct import path (was a typo: metircs -> metrics) and work regardless of CWD
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mevis_exp_path",
        type=str,
        default="/data1/pengrui/CodeSpace/Sa2VA/data/Sa2VA-Training/video_datas/mevis/valid_u/meta_expressions.json",
    )
    parser.add_argument(
        "--mevis_mask_path",
        type=str,
        default="/data1/pengrui/CodeSpace/Sa2VA/data/Sa2VA-Training/video_datas/mevis/valid_u/mask_dict.json",
    )
    ...
    if osp.dirname(args.save_name):
        output_path = args.save_name
    else:
