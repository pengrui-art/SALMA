...
from third_parts.revos.utils.metrics import (
    db_eval_iou,
    db_eval_boundary,
    get_r2vos_accuracy,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "pred_path",
        type=str,
        default="/data1/pengrui/Project/MySa2VA/work_dirs/refvos_revos_run1/results.json",
    )
    parser.add_argument(
        "--exp_path",
        type=str,
        default="/data1/pengrui/CodeSpace/Sa2VA/data/Sa2VA-Training/video_datas/revos/meta_expressions_valid_.json",
    )
    parser.add_argument(
        "--mask_path",
        type=str,
        default="/data1/pengrui/CodeSpace/Sa2VA/data/Sa2VA-Training/video_datas/revos/mask_dict.json",
    )
    parser.add_argument(
        "--foreground_mask_path",
        type=str,
        default="/data1/pengrui/CodeSpace/Sa2VA/data/Sa2VA-Training/video_datas/revos/mask_dict_foreground.json",
    )
    ...
    if osp.dirname(args.save_json_name):
        output_json_path = args.save_json_name
    else:
        output_json_path = osp.join(osp.dirname(args.pred_path), args.save_json_name)

    if osp.dirname(args.save_csv_name):
        output_csv_path = args.save_csv_name
    else:
