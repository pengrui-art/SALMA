...
model = dict(
    ...
    grounding_encoder=dict(
        ...
        # Mask-biased CMA (Phase1)
        enable_mask_bias=True,
        mask_bias_mode="gate",  # 'gate' or 'bias' (gate implemented now)
        mask_bias_tau=1.0,
        mask_bias_strength=1.0,
        mask_source="pred",  # use language-free predicted low-res masks as bias priors
        # Phrase-level routing (Phase2)
    ...
    loss_tmc_weight=0.1,
    loss_boundary_weight=0.0,  # Exp-5: Disable Boundary Loss
