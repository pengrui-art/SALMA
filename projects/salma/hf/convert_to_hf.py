...
def parse_args():
    ...
    parser.add_argument(
        "config",
        help="Config file name or path (e.g. projects/salma/configs/sa2va_1b.py)",
    )
...
def main():
    ...
    from projects.salma.hf.models.configuration_sa2va_chat import Sa2VAChatConfig
    ...
    try:
        from projects.salma.hf.models.templates import (
    ...
    # copy the files
    os.system(f"cp -pr ./projects/salma/hf/models/* {args.save_path}")
